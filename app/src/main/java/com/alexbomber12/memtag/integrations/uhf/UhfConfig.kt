...
data class UhfApplyResult(
    ...
    val success: Boolean = modeApplied && powerApplied && protocolApplied && rfLinkApplied
}

fun UhfApplyResult.toErrorMessage(): String {
    return "UHF config verify failed (modeApplied=$modeApplied " +
        "powerApplied=$powerApplied protocolApplied=$protocolApplied rfLinkApplied=$rfLinkApplied)."
}
